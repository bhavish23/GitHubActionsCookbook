...
ENV TOKEN="AM7XQE3W7OP7NAI432SLRV3HSYNCM"
ENV RUNNER_NAME="RUNNER_NAME_V1"
ENV RUNNER_URL="https://github.com/bhavish23/GitHubActionsCookbook"
ENV GH_RUNNER_PLATFORM="linux-x64"
ENV GH_RUNNER_VERSION="2.311.0"
ENV LABELS="self-hosted,x64,Linux"
